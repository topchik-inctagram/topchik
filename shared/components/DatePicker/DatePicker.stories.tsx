...
import {DatePicker, Label, Popover, PopoverContent, PopoverTrigger, Typography} from "@/shared/components";
    ...
    render: () => {
        ...
        return (
            <div style={{display: "flex", flexDirection: 'column', alignItems: 'flex-start'}}>
                ...
                <Popover>
                    <PopoverTrigger>
                        <Typography variant={'regular_16'} as={'span'}>{selectedRange?.from && selectedRange?.to
